...
def data_loader(PATH):
    ...
    with open('./Data/DeepSMILES.txt', 'r') as txt_file:
    ...
    total_data = 16780000
    img_name_train, img_name_val, cap_train, cap_val, tokenizer, max_length, image_features_extract_model = I2S_Data.data_loader(
        PATH, total_data)
